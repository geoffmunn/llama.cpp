...
class GGMLQuantizationType(IntEnum):
    ...
    TQ2_0   = 35
    MXFP4   = 39
    Q3_K_HIFI = 40              # Q3_K layout + 8 FP16 outliers per block
...
GGML_QUANT_SIZES: dict[GGMLQuantizationType, tuple[int, int]] = {
    ...
    GGMLQuantizationType.Q3_K_HIFI: (256, 137),  # Q3_K (110 bytes) + n_outliers(1) + outlier_idx[8] + _align_pad(1) + outlier_vals[16] + padding(1) = 137 bytes (optimized from 160)
