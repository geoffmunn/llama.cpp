...
static ggml_type tensor_type_fallback(quantize_state_impl & qs, const ggml_tensor * t, const ggml_type target_type) {
    ...
    if (ncols % qk_k != 0) { // this tensor's shape is incompatible with this quant
        ...
        switch (target_type) {
            ...
            case GGML_TYPE_Q3_K_LITE: return_type = GGML_TYPE_Q4_0; break;
            case GGML_TYPE_Q4_K_LITE: return_type = GGML_TYPE_Q5_0; break;
            case GGML_TYPE_Q5_K_LITE:
            case GGML_TYPE_Q3_K_HIFI_RES8:
            case GGML_TYPE_Q5_K_HIFI_RES8: return_type = GGML_TYPE_Q5_1; break;
            case GGML_TYPE_Q6_K_HIFI:
            case GGML_TYPE_Q6_K_HIFI_DYNAMIC:
            case GGML_TYPE_Q6_K_HIFI_RES8:
            case GGML_TYPE_Q6_K_LITE: return_type = GGML_TYPE_Q8_0; break;
            default:
