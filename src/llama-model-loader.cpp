...
static std::string llama_model_ftype_name(llama_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_Q3_K_HIFI: return "Q3_K_HIFI - ~3.7G (Q3_K_M base + scale-aware FP16 outlier enhancement)";
        case LLAMA_FTYPE_MOSTLY_Q5_K_HIFI: return "Q5_K_HIFI - ~5.4 bpw (Q5_K_M base + Q6_K_HIFI_RES8 on critical tensors)";
