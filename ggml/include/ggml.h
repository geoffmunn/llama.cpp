...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q2_K_LITE    = 44,
        GGML_TYPE_Q3_K_LITE    = 45,
        GGML_TYPE_Q4_K_LITE    = 46,
        GGML_TYPE_Q5_K_LITE    = 47,
        GGML_TYPE_Q6_K_LITE    = 48,
        GGML_TYPE_Q5_K_HIFI_RES8 = 49,
        GGML_TYPE_Q6_K_HIFI_RES8 = 50,
        GGML_TYPE_Q3_K_HIFI       = 51,
        GGML_TYPE_Q6_K_HIFI       = 52,
        GGML_TYPE_Q6_K_HIFI_DYNAMIC = 53,
        GGML_TYPE_Q3_K_HIFI_RES8   = 54,
        GGML_TYPE_COUNT            = 55,
    };
