...
// Q2_K_HIFI: Q2_K with 16 FP16 outliers for aggressive 2-bit quantization
GGML_API void quantize_row_q2_k_hifi_ref(const float * GGML_RESTRICT x, block_q2_k_hifi * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q2_k_hifi_ref_weighted(const float * GGML_RESTRICT x, block_q2_k_hifi * GGML_RESTRICT y, int64_t k, const float * GGML_RESTRICT quant_weights);
