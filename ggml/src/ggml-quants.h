...
GGML_API void quantize_row_q2_k_hifi_ref(const float * x, block_q2_k_hifi * y, int64_t k);
GGML_API void dequantize_row_q2_k_hifi(const block_q2_k_hifi * x, float * y, int64_t k);
GGML_API size_t quantize_q2_k_hifi(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst,
...
GGML_API size_t quantize_q4klite(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst,
                                    int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q5klite(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst,
                                    int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q6klite(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst,
                                    int64_t nrows, int64_t n_per_row, const float * imatrix);
