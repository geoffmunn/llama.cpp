...
// ---------------------------------------------------------------------------
// HIFI / LITE CPU vec_dot declarations
// ---------------------------------------------------------------------------
void quantize_row_q3_k_hifi_cpu(const float * x, void * y, int64_t k);
void quantize_row_q4_k_hifi_cpu(const float * x, void * y, int64_t k);
void quantize_row_q6_k_hifi_cpu(const float * x, void * y, int64_t k);
void quantize_row_q6_k_hifi_dynamic_cpu(const float * x, void * y, int64_t k);
void quantize_row_q2_k_hifi_cpu(const float * x, void * y, int64_t k);
void quantize_row_q6_k_hifi_res8_cpu(const float * x, void * y, int64_t k);
void quantize_row_q5_k_hifi_res8_cpu(const float * x, void * y, int64_t k);
void quantize_row_q3_k_hifi_res8_cpu(const float * x, void * y, int64_t k);
void quantize_row_q2_k_lite_cpu(const float * x, void * y, int64_t k);
void quantize_row_q3_k_lite_cpu(const float * x, void * y, int64_t k);
void quantize_row_q4_k_lite_cpu(const float * x, void * y, int64_t k);
void quantize_row_q5_k_lite_cpu(const float * x, void * y, int64_t k);
void quantize_row_q6_k_lite_cpu(const float * x, void * y, int64_t k);
