...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q2_K_HIFI] = {
        .from_float               = quantize_row_q2_k_hifi_ref,
        .vec_dot                  = ggml_vec_dot_q2_K_q8_K,  // Reuse Q2_K vec_dot (compatible base layout)
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q3_K] = {
    ...
    [GGML_TYPE_Q6_K_HIFI_RES8] = {
        ...
        .vec_dot                  = ggml_vec_dot_q6_k_hifi_res8_q8_K, // Compact INT8 residuals kernel
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
