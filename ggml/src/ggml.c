...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q3_K_LITE:  result = quantize_q3klite(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_K_LITE:  result = quantize_q4klite(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q5_K_LITE:  result = quantize_q5klite(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q6_K_LITE:  result = quantize_q6klite(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
