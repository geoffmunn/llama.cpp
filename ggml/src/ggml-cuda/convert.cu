...
to_fp16_cuda_t ggml_get_to_fp16_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q2_K:
            return dequantize_row_q2_K_cuda<half>;
        case GGML_TYPE_Q3_K:
            return dequantize_row_q3_K_cuda<half>;
        case GGML_TYPE_Q3_K_HIFI:
            return dequantize_row_q3_k_hifi_cuda<half>;
        case GGML_TYPE_Q3_K_HIFI_RES8:
            return dequantize_row_q3_k_hifi_res8_cuda<half>;
        case GGML_TYPE_Q6_K_HIFI:
            return dequantize_row_q6_k_hifi_cuda<half>;
        case GGML_TYPE_Q6_K_HIFI_DYNAMIC:
            return dequantize_row_q6_k_hifi_dynamic_cuda<half>;
        case GGML_TYPE_Q6_K_HIFI_RES8:
            return dequantize_row_q6_k_hifi_res8_cuda<half>;
        case GGML_TYPE_Q5_K_HIFI_RES8:
            return dequantize_row_q5_k_hifi_res8_cuda<half>;
        case GGML_TYPE_Q4_K:
            return dequantize_row_q4_K_cuda<half>;
        case GGML_TYPE_Q5_K:
            return dequantize_row_q5_K_cuda<half>;
        case GGML_TYPE_Q6_K:
            return dequantize_row_q6_K_cuda<half>;
        case GGML_TYPE_IQ2_XXS:
            return dequantize_row_iq2_xxs_cuda<half>;
        case GGML_TYPE_IQ2_XS:
            return dequantize_row_iq2_xs_cuda<half>;
        case GGML_TYPE_IQ2_S:
            return dequantize_row_iq2_s_cuda<half>;
        case GGML_TYPE_IQ3_XXS:
            return dequantize_row_iq3_xxs_cuda<half>;
        case GGML_TYPE_IQ1_S:
            return dequantize_row_iq1_s_cuda<half>;
        case GGML_TYPE_IQ1_M:
            return dequantize_row_iq1_m_cuda<half>;
        case GGML_TYPE_IQ4_NL:
            return dequantize_row_iq4_nl_cuda<half>;
        case GGML_TYPE_IQ4_XS:
            return dequantize_row_iq4_xs_cuda<half>;
        case GGML_TYPE_IQ3_S:
            return dequantize_row_iq3_s_cuda<half>;
