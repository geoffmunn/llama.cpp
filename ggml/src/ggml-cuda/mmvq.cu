...
static constexpr __device__ vec_dot_q_cuda_t get_vec_dot_q_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q2_K_HIFI: return vec_dot_q2_K_q8_1;  // Reuse Q2_K kernel (compatible base layout)
...
static constexpr __device__ int get_vdr_mmvq(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q2_K_HIFI: return VDR_Q2_K_Q8_1_MMVQ;  // Same as Q2_K
