...
// MMVQ path: Use Q2_K base only (residual corrections too complex for vec_dot)
// Full residual correction is applied in dequant path
...
#pragma unroll
    ...
    return vec_dot_q2_K_q8_1_impl_mmvq(v, u, scales, bq2_k_hifi->dm, d8);
}
