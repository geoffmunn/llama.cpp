...
// Q6_K_HIFI: same logic as Q6_K but with correct 222-byte block stride
static __device__ __forceinline__ float vec_dot_q6k_hifi_q8_1(
    ...
    const int vh = get_int_b2(bq6->qh, (QI6_K/4) * (iqs / (QI6_K/2)) + iqs % (QI6_K/4)) >> vh_shift;
...
#pragma unroll
    ...
    return vec_dot_q6_K_q8_1_impl_mmvq(vl, vh, u, scales, bq6->d, d8);
}
